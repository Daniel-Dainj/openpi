...
folder_path = '/media/dainanjun/T9/new'  # 大文件夹路径
    ...
    if task_folder.is_dir():  # 确保是文件夹
        ...
        for h5_file in h5_files:
            ...
            with h5py.File(h5_file, 'r+') as f:
                ...
                # 这里不再删除最后一帧，保留它不变
                # 保存修改后的文件
                print(f"Successfully updated the action/joint_position and action/gripper_position datasets in file: {h5_file.name}")
